...
st.title("MVCD")
st.markdown("Motor vehicle streamlit app")
...
st.header("where most people injured ?")
injured_people = st.slider("num of persons injured",0,19)
st.map(data.query("injured_persons >= @injured_people")[["latitude","longitude"]].dropna(how="any"))

st.header("collisions at time")
...
st.subheader("Breakdow by min between %i:00 and %i:00"%(hour,(hour+1)%24))
